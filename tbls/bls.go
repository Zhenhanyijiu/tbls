...
/*
#cgo CFLAGS:-I../herumi/bls/include -I../herumi/mcl/include/
#cgo LDFLAGS:-L../herumi/bls/lib -L../herumi/mcl/lib
#cgo CFLAGS:-DMCLBN_FP_UNIT_SIZE=6
#cgo LDFLAGS:-lbls384 -lmcl -lcrypto -lgmp -lgmpxx -lstdc++ //static library
#include <bls/bls.h>
*/
import "C"
import (
...
func (sk *SecretKey) IsEqualFromCom(comVec []PublicKey, id *ID) bool {
	var pkfromcom PublicKey
...
//aggragate the secret
func (sksum *SecretKey) SeckeyAggregate(seck []SecretKey) {
...
func (gpk *PublicKey) GenGroupPubKey(pks []PublicKey) {
	gpk.SetHexString("0")
	for _, pk := range pks {
		gpk.Add(&pk)
	}
